...
@imageex storage=sakura03a page=fore visible=true layer=2 left=900 top=400 opacity=255
@backlay layer=0
@backlay layer=1
@backlay layer=2
@backlay layer=3
...
@se file=se150 nowait=true
@move base=星大 layer=4 px=150 py=240 cx=224 cy=246 mag=0.2 deg=0 opacity=0 affine=(50,100,120,0.3,255,224,246)(,,,,0,,) time=800 accel=-2
...
@image storage=襖左大b page=fore visible=true layer=0 left=-600 top=0 opacity=255 nocondition=1
;@image storage=襖左大 page=fore visible=true layer=0 left=-400 top=0 opacity=255
@image storage=襖右大b page=fore visible=true layer=1 left=900 top=0 opacity=255 nocondition=1
;@image storage=襖右大 page=fore visible=true layer=1 left=800 top=0 opacity=255
@se file=se188 nowait=true
@move layer=0 path=(-107.5,0,255) time=1500 accel=-4
;@move layer=0 path=(0,0,255) time=1500 accel=-4
@move layer=1 path=(400,0,255) time=1500 accel=-4
@wm canskip=false
@wm canskip=false
@fadein file=襖 time=800 method=crossfade nocondition=1
@superpose storage=襖後 index=1000 opacity=255
@redraw method=crossfade time=0
@image storage=i間桐邸地下修練所-(緑) page=back layer=base
@image storage=襖左 page=fore visible=true layer=3 left=146 top=0 opacity=255 nocondition=1
;@image storage=襖左 page=fore visible=true layer=3 left=119 top=0 opacity=255
@image storage=襖右 page=fore visible=true layer=4 left=400 top=0 opacity=255 nocondition=1
@backlay layer=3
@backlay layer=4
...
@wm canskip=false
@waitT canskip=false time=800
@image storage=襖左 page=fore visible=true layer=0 index=1100 left=146 top=0 opacity=255 nocondition=1
;@image storage=襖左 page=fore visible=true layer=0 index=1100 left=119 top=0 opacity=255
@image storage=襖右 page=fore visible=true layer=2 left=400 top=0 opacity=255 nocondition=1
@image storage=sakura01d page=fore visible=true layer=1 left=450 top=400 opacity=255 nocondition=1
@image storage=saber02b page=fore visible=true layer=4 left=0 top=600 opacity=255 nocondition=1
@image storage=rinn02b page=fore visible=true layer=3 left=800 top=600 opacity=255 nocondition=1
@move layer=4 path=(90,400,255) time=600 accel=-4
@move layer=3 path=(530,410,255) time=600 accel=-4
@wm canskip=false
@wm canskip=false
@move layer=0 path=(117,0,255) time=500 accel=-2
...
@wm canskip=false
@wm canskip=false
@move layer=0 path=(146,0,255) time=50
...
@wm canskip=false
@wm canskip=false
@move layer=0 path=(117,0,255) time=200 accel=-2
...
@wm canskip=false
@wm canskip=false
@move layer=0 path=(117,0,255) time=30
...
@wm canskip=false
@wm canskip=false
@move layer=0 path=(146,0,255) time=30
...
@wm canskip=false
@wm canskip=false
@image storage=saber02a page=fore visible=true layer=4 left=100 top=390 opacity=255 nocondition=1
@image storage=rinn02a page=fore visible=true layer=3 left=530 top=400 opacity=255 nocondition=1
@waitT canskip=false time=600
@move layer=4 path=(-230,420,255) time=1200 accel=-2
;@move layer=4 path=(-150,420,255) time=1000 accel=-2
@move layer=3 path=(880,450,255) time=1200 accel=-2
...
@superpose_off
@stoptrans
@fadein file=襖 time=100 method=crossfade nocondition=1
@waitT canskip=false time=1000
@blackout method=crossfade time=1000
@unlockachievement id=achievement_0026
