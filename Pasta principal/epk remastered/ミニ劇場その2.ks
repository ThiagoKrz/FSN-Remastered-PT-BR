...
@move base=rinn02b layer=2 px=280 py=470 cx=0 cy=0 mag=2.7 deg=50 opacity=0 affine=(280,280,20,1.3,128,,)(280,120,0,0.96,255,,) time=1500 accel=-3
;@move base=rinn02b layer=2 px=300 py=550 cx=0 cy=0 mag=3 deg=50 opacity=0 affine=(300,360,20,1.5,128,,)(300,200,0,1,255,,) time=1500 accel=-3
@wm canskip=false
@sestop file=se388 time=8500 nowait=true
@image storage=rinn02b page=fore visible=true layer=2 left=305 top=193 opacity=255 magnify=0.96
;@image storage=rinn02b page=fore visible=true layer=2 left=300 top=200 opacity=255 magnify=0.96
@move layer=2 path=(305,290,255) time=600 accel=2
;@move layer=2 path=(300,300,255) time=600 accel=2
@wm canskip=false
@move layer=2 path=(305,390,255) time=600 accel=-3
;@move layer=2 path=(300,400,255) time=600 accel=-3
@wm canskip=false
@imageex storage=stagestart03 page=fore visible=true layer=4 left=-50 top=10 opacity=0 magnify=0.90 spread=1
...
@wm canskip=false
@se file=se121 nowait=true
@move base=弾幕a layer=4 px=360 py=70 cx=210 cy=210 mag=0.1 deg=0 opacity=255 affine=(300,90,180,0.6,255,,)(240,140,360,0.9,255,,) time=3500
...
@layopt layer=3 opacity=0
@move base=弾幕b layer=3 px=360 py=70 cx=210 cy=210 mag=0.1 deg=0 opacity=255 affine=(400,220,-90,0.6,255,,)(440,370,-180,0.9,255,,) time=3100
...
@move base=弾幕c layer=1 px=390 py=70 cx=85 cy=27 mag=0.9 deg=10 opacity=255 affine=(405,400,,,255,,)(420,550,,,255,,) time=500 accel=2
...
@wm canskip=false
@move base=弾幕c layer=1 px=400 py=120 cx=85 cy=27 mag=1 deg=0 opacity=255 affine=(400,390,0,1,255,,)(400,530,0,1,255,,) time=600 accel=2
...
@wm canskip=false
@move base=弾幕c layer=1 px=415 py=85 cx=85 cy=27 mag=0.8 deg=-45 opacity=255 affine=(350,130,-45,1,255,,)(280,180,-45,1,255,,) time=300 accel=2
...
@dashcomboT storage=08魔術・光弾 hidefg=false layer=base cx=694 cy=37 imag=8 mag=4 opacity=96 wait=0 time=200
@waitT canskip=false time=200
@dashcomboT storage=06火花 hidefg=false layer=base cx=360 cy=400 imag=3 mag=8 opacity=96 wait=0 time=200
@image storage=rinn03_150 page=fore visible=true layer=3 left=-80 top=100 opacity=0
;@image storage=rinn03_150 page=fore visible=true layer=3 left=0 top=100 opacity=0
@image storage=sakura03_150 page=fore visible=true layer=4 left=430 top=-100 opacity=0
;@image storage=sakura03_150 page=fore visible=true layer=4 left=350 top=-100 opacity=0
@move layer=3 path=(-80,0,255) time=1000
;@move layer=3 path=(0,0,255) time=1000
@move layer=4 path=(430,0,255) time=1000
;@move layer=4 path=(350,0,255) time=1000
@wm canskip=false
@wm canskip=false
@waitT canskip=false time=200
@move layer=3 path=(-80,-100,0) time=1000
;@move layer=3 path=(0,-100,0) time=1000
@move layer=4 path=(430,100,0) time=1000
...
@unlockachievement id=achievement_0027
